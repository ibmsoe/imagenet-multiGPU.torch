...
local DataParallelTable, parent = torch.class('DataParallelTable', 'nn.Container',M)

local Impls = {}
local BasicImpl = torch.class('DataParallelTable.Basic', Impls)
local ThreadsImpl = torch.class('DataParallelTable.Threads', Impls)
...
function DataParallelTable:__init(dimension, flattenParams, usenccl, useThreads)
   parent.__init(self)
